...
<div class="container-detail">
  ...
  <form class="row g-3 needs-validation" action="../config/cadastro_cliente.php" method="POST" novalidate>
    <div class="col-md-6">
      <label for="inputEmail" class="form-label">EMAIL</label>
      <input type="text" class="form-control" id="inputEmail" name="inputEmail" placeholder="Ex: example@example.com" required>
    </div>
    <div class="col-md-6">
      <label for="inputUser" class="form-label">NOME DE USUARIO</label>
      <input type="text" class="form-control" id="inputUser" name="inputUser" placeholder="Ex: João Paulo" required>
    </div>
    <div class="col-md-2">
      <label for="cpf" class="form-label">CPF</label>
      <input type="text" class="form-control" id="cpf" name="cpf" placeholder="Ex: 000.000.000-00" maxlength="14" required>
    ...
    <div class="col-md-2">
      <label for="dateN" class="form-label">DATA DE NASCIMENTO</label>
      <input type="date" class="form-control" id="dateN" name="dateN" onblur="calculaIdade()" required>
    </div>
    ...
    <div class="col-3">
      ...
      <input type="text" class="form-control" id="inputCellphone" name="inputCellphone" placeholder="(47) 9 9999-9999" maxlength="15">
    </div>
    <div class="col-3">
      <label for="inputTelephone" class="form-label">NÚMERO DE TELEFONE</label>
      <input type="text" class="form-control" id="inputTelephone" name="inputTelephone" placeholder="(47) 3333-3333" maxlength="14">
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-1">
      <label for="inputNumber" class="form-label">Nº</label>
      <input type="text" class="form-control" id="inputNumber" placeholder=" 800" name="inputNumber"  aria-describedby="validationServer03Feedback" required>
    </div>
    <div class="col-md-3">
      <label for="inputComplement" class="form-label">COMPLEMENTO</label>
      <input type="text" class="form-control" id="inputComplement" placeholder="Apartment, studio, or floor" name="inputComplement" aria-describedby="validationServer03Feedback" required>
    </div>
    <div class="col-md-3">
      <label for="inputDistrict" class="form-label">BAIRRO</label>
      <input type="text" class="form-control" id="inputDistrict" name="inputDistrict" aria-describedby="validationServer03Feedback" required>
