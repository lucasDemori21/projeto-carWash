      ...
      <div class="offcanvas offcanvas-start" style="border-right: 1px solid #00E0FF;" data-bs-scroll="false" data-bs-backdrop="false" tabindex="-1" id="offcanvasScrolling" aria-labelledby="offcanvasScrollingLabel">
        ...
        <div class="nav-button">
          ...
          ?>
            <div class="nav-button">
              <a href="../index.php"><button>
                <svg style="margin-right: 7%; margin-top: 1%; float: left; width: 22px; height: 22px;"
                    xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-speedometer"
                    viewBox="0 0 16 16">
                    <path
          ...
          ?> 
            ...
            <div class="nav-button">
          <a href="cadastro_veiculo.php"><button>
          ...
          <div class="nav-button">
            <a href="detalhe.php"><button>
              <svg style="margin-right: 7%; margin-top: 1.2%; float: left; width: 22px; height: 22px;"
                  xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-info-circle"
                  viewBox="0 0 16 16">
          ...
          <div class="nav-button">
            <a href="perfil.php">
              <button>
              <svg style="margin-right: 7%; margin-top: 1.2%; float: left; width: 22px; height: 22px;" xmlns="http://www.w3.org/2000/svg" width="20"
                  height="20" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
                  <path d="M11 6a3 3 0 1 1-6 0 3 3 0 0 1 6 0z" />
                  <path fill-rule="evenodd"
                    d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8zm8-7a7 7 0 0 0-5.468 11.37C3.242 11.226 4.805 10 8 10s4.757 1.225 5.468 2.37A7 7 0 0 0 8 1z" />
                </svg>
                <div style="padding-top: 1%;">Perfil</div>
              </button>
            </a>
          </div>
          <?php
